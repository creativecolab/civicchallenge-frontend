    ...
    <section className={styles.CodeOfConduct}>
      ...
      <div className={globalStyles.pageWrapper}>
        ...
        <div className={globalStyles.contentContainer}>
          {CONDUCT_DETAILS.map(paragraphText =>
            <p
              key={paragraphText}
