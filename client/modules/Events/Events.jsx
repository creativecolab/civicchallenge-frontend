...
class Events extends React.PureComponent {
  ...
  _onWindowScroll = () => {
    ...
    for (let i = this.overviews.length - 1; i >= 0; i -= 1) {
      if (this.resources.getBoundingClientRect().top <= 30) {
        newCurrentSection = Events.CURRENTSECTION_RESOURCES;
        break;
      }
  ...
  render() {
    ...
    const { headerImg, challengeTitle, question, overview } = pageInfo;
          ...
          <div className={globalStyles.contentWrapper}>
            <div className={styles.menu}>
              ...
              <ul className={styles.sidebar}>
                ...
                <a>
                  <li
                    className={currentSection === Events.CURRENTSECTION_RESOURCES ? styles.current : ''}
