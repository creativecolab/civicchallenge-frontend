...
const CHALLENGE_INFO = {
  walking: {
    ...
    overview: [
      ...
      },
      {
        ...
        text: 'Everyday car-bike collisions result in injury, if not the death of a cyclist. Though is making the cyclist more visible the core design challenge? On the one hand, <a href="http://www.sandiegouniontribune.com/news/politics/sd-me-urban-forest-20170124-story.html" rel="noopener noreferrer" target="_blank">there are 217,000 trees adjacent to streets in the city of San Diego</a>. This foliage may be concealing cyclists and pedestrians from the view of drivers. On the other hand, <a href="http://www.nolo.com/legal-encyclopedia/bike-accidents-collisions-with-cars-29549.html" rel="noopener noreferrer" target="_blank">45% of bike accidents that involve a car happen at intersections</a>, moments when a driver needs to make a quick and complex series of decisions. It may be that drivers need different forms of assistance to account for pedestrians and bikers at various points along their drive home.',
        link: '',
        linkText: 'Discuss this in Slack (coming soon)',
  ...
  improvingaccessibility: {
    ...
    intro: 'Getting around can be a challenge for anyone, but particularly for people with disabilities and the elderly population. What does this mean for mobility in San Diego? First of all, approximately 17% of San Diegans have some form of physical, sensory, mental, or cognitive impairment that affects their mobility. Aging also affects one’s ability to move freely around the city; and individuals over the age of 60 represent the fastest growing segment of the population. In fact, the number of San Diego’s senior residents is expected to <a href="http://www.sandiegouniontribune.com/news/health/sd-me-age-friendly-20161219-story.html" rel="noopener noreferrer" target="_blank">double by 2030</a>! How can we improve accessibility in San Diego with the specific needs of people with impairments and elderly people in mind?',
    overview: [
      {
        title: 'Sensory impairments: How do you move around if you cannot see or hear?',
        text: 'Most of us take our eyes and ears for granted. For those with sensory disabilities, navigating the city can be a challenge. For people who are blind and others with poor vision, it can be difficult to walk through urban environments and to take public transit. <a href="https://www.sdmts.com/" rel="noopener noreferrer" target="_blank">San Diego’s Metropolitan Transit System</a> has outfitted all stations with raised letters and braille plates identifying the route and direction (North/South/East/West), but challenges remain. For example, even the step onto a train can be intimidating. How do people with sensory impairments overcome these everyday barriers? How can the signage at our metro stations be improved? For individuals who are deaf or hearing impaired, the challenge may be a lack of auditory cues. For example, a deaf individual might not hear a big truck bearing down or loud sirens from an ambulance. However, people with partial hearing may have difficulty crowded or loud environments, where the background noise can drown out important messages. How might we improve safety when auditory clues are not available?',
        link: '',
        linkText: 'Discuss this in Slack (coming soon)',
      ...
      {
        title: 'Mobility impairments: How do you navigate stairs in a wheelchair?',
        text: 'A person with a mobility impairment (e.g., requiring crutches, a cane, or a wheelchair) often has difficulty with stairways and high curbs, and avoiding these physical barriers may take them in circuitous routes, which might even be more treacherous in rainy and winter conditions. The lack of convenient, accessible, and affordable forms of transportation for disabled people is a major problem in San Diego. How might we improve access to our city for people with mobility impairments?<br><br>Though before reinventing the wheel for this Mobility Challenge, it is important to note that there are several existing services in San Diego available to people with mobility impairments. These services include the <a href="http://sdcvdc.org/" rel="noopener noreferrer" target="_blank">San Diego Volunteer Drivers Coalition</a> and the <a href="http://www.factsd.org/ada-paratransit/" rel="noopener noreferrer" target="_blank">ADA Paratransit shuttles</a>. Ride sharing applications, like <a href="https://help.lyft.com/hc/en-us/articles/213584508-Accessible-vehicle-dispatch" rel="noopener noreferrer" target="_blank">Lyft’s Accessible Vehicle Dispatch</a>, have made it relatively easy to plan trips across town. How might we improve this existing infrastructure to better serve people with physical impairments?',
        link: '',
        linkText: 'Discuss this in Slack (coming soon)',
        figureA: stairs,
  ...
  traffic: {
    ...
    overview: [
      ...
      },
      {
        ...
        text: 'Users of public transit in San Diego have recently reported increased dissatisfaction with transit costs, public transit availability, and cleanliness at public transit areas. The <a href="https://www.sdmts.com/" rel="noopener noreferrer" target="_blank">Metropolitan Transit System</a> (MTS) and <a href="http://www.gonctd.com/" rel="noopener noreferrer" target="_blank">North County Transit District</a> (NCTD) need better ways of hearing and responding to public transit riders. San Diego’s public transit infrastructure is extensive. MTS is currently working on the <a href="http://www.sandag.org/index.asp?projectid=250&fuseaction=projects.detail" rel="noopener noreferrer" target="_blank">Mid-Coast Trolley Project</a>, which will increase accessibility to public transit in San Diego. Improvements designed with public transportation users in mind can motivate them to continue using public transportation, which ultimately benefits San Diego residents and businesses financially, and it helps San Diego to be more environmentally-friendly. What are the best ways to connect with this population of riders, and actively get their input about specific spots that need improvement? Even the design of that “feedback” may need improvement.',
        link: '',
        linkText: 'Discuss this in Slack (coming soon)',
        figureA: communicate,
      ...
      {
        title: 'Mobility hubs: How can we seamlessly bring together multiple transportation options?',
        text: 'A mobility hub is an ecosystem of various transportation options and technologies located in smart growth opportunity areas that serve high-frequency transit. This system is an innovation from the <a href="http://www.sandag.org/" rel="noopener noreferrer" target="_blank">San Diego Association of Governments</a> (SANDAG), which is an organization that plans, allocates resources, and provides information on a variety of topics regionally. Mobility hubs are places of connectivity, and an important goal of one is to reduce greenhouse gas emissions and single-occupancy vehicles. The services within a mobility hub also help commuters make short trips around their regional area, and reduce traffic while decreasing transportation costs.<br><br>Mobility hubs are more than just transit centers. Rather, it is a unified network of mobility services, drawing upon technological and urban design enhancements where connections between transportation options (biking, walking, bussing) come together seamlessly. One proposed feature of a mobility hub is an app that a user could log onto with a universal transportation account where they could pay for a variety of mobility services. In addition, autonomous and automated transportation services that will be implemented in the future and be integral to future mobility hubs. What kind of transportation amenities would you like to see in a local mobility hub?',
        link: '',
        linkText: 'Discuss this in Slack (coming soon)',
        figureA: hub,
        figureALink: 'mobility hub',
        figureB: '',
        figureBLink: '',
        figureC: '',
        figureCLink: '',
  ...
  autonomousvehicles: {
    ...
    overview: [
      ...
      },
      {
        ...
        text: 'San Diego is one of the 10 cities that <a href="http://www.dmv.org/articles/self-driving-in-the-sunshine-san-diego-to-test-driverless-cars/" rel="noopener noreferrer" target="_blank">has been selected by the Department of Transportation</a> to test introducing autonomous vehicles (AVs) to city streets. Though it’s important to note that AVs not only ride on the streets, they might also talk with the street, the light signals and all other sensors even miles down the road. AVs use onboard sensors to detect potential immediate hazards, but also integrate with other cars and sensors in a communication network that connects them to potential dangers miles ahead.<br><br>For passengers, these safety precautions add to a relaxing experience of being chauffeured, but for walkers, bikers and others’ on the road, negotiating traffic with an AV may be a stressful experience. How might an AV signal to a walker or biker that they have been “seen” and accounted for in the navigation routing system, and that it’s actually safe to walk?<br><br>Another concern is that computing systems can be hacked. To communicate with other cars and sensors along the drive, AVs access part of the radio frequency spectrum set aside explicitly for cars, and called <a href="https://www.rcrwireless.com/20151020/featured/what-is-dsrc-for-the-connected-car-tag6" rel="noopener noreferrer" target="_blank">“Dedicated Short-Range Communication”</a>. AVs can use this frequency to communicate with other sensors within a 1,000 foot range. However, because AVs are open to receive signals it leaves them vulnerable to hacking. Hacking a car is somewhat different than breaking in and stealing the vehicle—hacked cars might be rerouted, used to reroute other vehicles, or hacking might simply be to delete the car’s log files. All frightening possibilities that need design solutions.',
        link: '',
        linkText: 'Discuss this in Slack (coming soon)',
        figureA: stopSigns,
